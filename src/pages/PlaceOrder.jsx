...
const PlaceOrder = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between gap-4 pt-4 sm:pt-14 min-h-[80vh] border-t border-gray-200">
      {/* Left Side */}
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
        <div className="text-xl sm:text-2xl my-3">
          <Title main={'DELIVERY'} highlight={'INFORMATION'} />
        </div>
      ...
      <div className="mt-8">
        ...
        <div className="mt-12">
          <Title main={'PAYMENT'} highlight={'METHOD'} />
