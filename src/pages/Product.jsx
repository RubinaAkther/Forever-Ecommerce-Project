...
const Product = () => {
  ...
  return productData ? (
    <div className="border-t border-gray-200 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="mt-20">
        <div className="flex">
          <b className="border border-b-0 border-gray-200 px-5 py-3 text-sm">
            Description
          </b>
          <p className="border border-l-0 border-b-0 border-gray-200 px-5 py-3 text-sm">
            Reviews (122)
          </p>
        </div>
        <div className="flex flex-col gap-4 border border-gray-200 px-6 py-6 text-sm text-gray-500">
          ...
          <p>
            ...
            Its lightweight fabric ensures maximum comfort throughout the day,
            whether you're out and about or lounging at home. The classic round
            neck design adds a timeless touch, making it easy to pair with any
            outfit. Ideal for casual wear, this T-shirt strikes the perfect
            balance between comfort and style. Upgrade your everyday essentials
            with this versatile and reliable piece.
          </p>
        </div>
      </div>
